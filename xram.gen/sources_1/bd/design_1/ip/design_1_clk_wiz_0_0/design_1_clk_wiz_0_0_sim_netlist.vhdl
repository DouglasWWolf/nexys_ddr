...
--               c:/fpga/xram/xram.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_0_0/design_1_clk_wiz_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_clk_wiz_0_0_clk_wiz is
  ...
  signal ddr_ref_clk_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal ddr_ref_clk_design_1_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal ddr_sys_clk_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal ddr_sys_clk_design_1_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => ddr_ref_clk_design_1_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => ddr_ref_clk,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => ddr_ref_clk_design_1_clk_wiz_0_0,
      O => ddr_ref_clk_design_1_clk_wiz_0_0_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => ddr_sys_clk_design_1_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => ddr_sys_clk,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => ddr_sys_clk_design_1_clk_wiz_0_0,
      O => ddr_sys_clk_design_1_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => ddr_ref_clk_design_1_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => ddr_sys_clk_design_1_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => ddr_ref_clk_design_1_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => locked_int,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => ddr_sys_clk_design_1_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => locked_int,
      Q => seq_reg2(0)
